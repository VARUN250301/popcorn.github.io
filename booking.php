            ...
            <div class="booking-form-container">
                <form action="" method="POST">
                    ...
                    <select name="date" required>
                        ...
                        <option value="28-10">October 28,2022</option>
                        <option value="29-10">October 29,2022</option>
                        <option value="30-10">October 30,2022</option>
                        <option value="31-10">October 31,2022</option>
                    ...
                    <button type="submit" value="submit" name="submit" class="form-btn">Confirm</button>
                ...
                <div style="display: flex; justify-content: center; align-items: center; margin: 3px">
                <button style="background-color: #8B8000; color: white; padding: 7px; border: none; border-radius: 5px;"><a href="seat.php">Select Seats</a></button>
                </div>
