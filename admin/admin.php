...
<body>
    ...
    $abc = "SELECT * FROM feedbackTable";
    $def = "SELECT * FROM movietable"
    ?>
        ...
        <div class="admin-section admin-section2">
            ...
            <div class="admin-section-column">
                ...
                <div class="admin-section-panel admin-section-panel1">
                    ...
                    <div class="admin-panel-section-content">
                        <?php
                        if($res = mysqli_query($link, $abc)){
                            if(mysqli_num_rows($res) > 0){
                                while($rowa = mysqli_fetch_array($res)){
                                    echo "<div class=\"admin-panel-section-booking-item\">\n";
                                    echo "                            <div class=\"admin-panel-section-booking-response\">\n";
                                    echo "                                <i class=\"fas fa-check accept-booking\" title=\"Verify booking\"></i>\n";
                                    echo "                                <a href='deletefeedback.php?id=".$rowa['msgID']."'><i class=\"fas fa-times decline-booking\" title=\"Reject booking\"></i></a>\n";
                                    echo "                            </div>\n";
                                    echo "                            <div class=\"admin-panel-section-booking-info\">\n";
                                    echo "                                <div>\n";
                                    echo "                                    <h3>". $rowa['senderfName'] ."</h3>\n";
                                    echo "                                    <i class=\"fas fa-circle \"></i>\n";
                                    echo "                                    <h4>". $rowa['senderlName'] ."</h4>\n";
                                    echo "                                    <i class=\"fas fa-circle \"></i>\n";
                                    echo "                                    <h4>". $rowa['senderfeedback'] ."</h4>\n";
                                    echo "                                    <i class=\"fas fa-circle \"></i>\n";
                                ...
                                echo '<h4 class="no-annot">No Bookings feedbacks now</h4>';
                            }
                        } else{
                            echo "ERROR: Could not able to execute $abc. " . mysqli_error($link);
                        }
                        ?>
                    </div>
                </div>
